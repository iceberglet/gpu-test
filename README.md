...
1. install Nvidia CUDA toolkit https://developer.nvidia.com/cuda-toolkit-archive (12.0.0 for latest jcuda, latest for LWJGL)
2. fix "cl.exe" path e.g. : C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.39.33519\bin\Hostx64\x64
   - [If on Linux] requires gcc compiler and toolchain
